...
/**
 * Hello world! You are given a (small) check book as a - sometimes - cluttered
 ...
 * need):
 * 
 * "Original_Balance:_1000.00 125_Market_125.45_Balance_874.55
 ...
 * Total_expense__198.27 Average_expense__39.65" On each line of the report you
 * have to add the new balance and then in the last two lines the total expense
 * and the average expense. So as not to have a too long result string we don't
 * ask for a properly formatted result.
 * 
 * Notes One (or more) line can be blank. Round to 2 decimals your results. The
 * line separator of results may depend on the language \n or \r\n. You can see
